...
let favoriteFoods = ['Tacos', 'Banh Mi', 'Ramen', 'Borscht', 'Spaghetti'];
...
console.log('One of my favorite animals is the noble ' + secondAnimal + '.');
...
console.log('I also like ' + lastAnimal + 's.');
...
let entree = 'Putanesca';
favoriteFoods.unshift(entree);
console.log(entree + ' is delicious.')
...
gems[1] = 'Tourmaline';
console.log('Replaced second gem with Tourmaline:', gems);
...
gems.sort().reverse();
console.log('Sorted gems in reverse alphabetical order:', gems);
